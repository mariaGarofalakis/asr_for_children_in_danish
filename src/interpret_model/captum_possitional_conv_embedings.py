...
lig = LayerIntegratedGradients(squad_pos_forward_func, model.wav2vec2.encoder.pos_conv_embed)
...
with open(r'/zhome/2f/8/153764/Desktop/final/convolutional_embendings.txt', 'w') as fp:
    for item in embedings_conv:
